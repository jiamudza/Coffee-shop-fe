              ...
              <div className=''>
                ...
                <div className='flex flex-col items-center bottom-3'>
                  <p className='text-title font-bold'>IDR 25.000</p> 
                    <button className='px-20 py-3 rounded-3xl mt-3 bg-transparent border-2 font-bold border-secondary text-secondary hover:bg-primary hover:border-secondary ease-in-out duration-300 '>Select</button>
                </div>
            </div>
        </div>
