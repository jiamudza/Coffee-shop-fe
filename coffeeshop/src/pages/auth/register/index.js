...
const Register = () => {
  ...
  const handleLogin = (e) => {
    ...
    axios({
      url: `https://coffeeshop-be.adaptable.app/api/v1/auth/register`,
      method: 'POST',
      data: {
    ...
    <>
      <div className='md:flex font-rubik'>
        <div className='hidden md:block w-[50%]'>
          <img src={authImg} alt="auth-image.jpg" className='w-full h-[120vh] object-cover'/>
        </div>
          ...
          <div className='h-[100vh] text-white lg:text-title '>
            <div className='hidden md:flex pt-5 items-center justify-between'>
              <Link to="/" className='flex items-center font-bold'>
                ...
                <Link to="/login" className='px-5 py-2 bg-primary text-secondary font-bold rounded-3xl hover:bg-secondary hover:text-white ease-in duration-200'>Login</Link>
              
            </div>

            <p className='font-bold text-4xl pt-10  md:text-center md:text-secondary md:shadow-primary'>Sign Up</p>
            ...
            <form className='font-bold mt-52 md:mt-14 md:font-[500] md:px-20' >
              ...
              <label className='hidden md:block font-bold text-text'>Number :</label>
              <input onChange={(e) => {
                setFormLogin({
                  ...formLogin,
              ...
              <Link to="/login" className='text-sm border-b md:border-secondary md:border-b-2 md:text-secondary md:font-bold '>Login Instead?</Link>
