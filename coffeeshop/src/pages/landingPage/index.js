    ...
    <div  className='relative h-[200vh]'>
      ...
      <section className='text-text flex items-center justify-between mt-10 lg:mx-28 md:mt-28'>
        ...
        <div className='mx-auto'>
          ...
          <span className='flex items-center py-3'><BsCheckCircleFill size={18} color='#2FAB73' className='align-bottom w-5 h-5'/><p className='px-2 md:px-4'>High quality beans</p></span>
          <span className='flex items-center py-3'><BsCheckCircleFill size={20} color='#2FAB73' className='align-bottom w-5 h-5'/><p className='px-2 md:px-4'>Healthy meals, you can request the ingredients</p></span>
          <span className='flex items-center py-3'><BsCheckCircleFill size={20} color='#2FAB73' className='align-bottom w-5 h-5'/><p className='px-2 md:px-4'>Chat with our staff to get better experience for <br className='md:hidden' /> ordering</p></span>
